...
export class RestService {
    ...
    createTokenizeRequest(
        httpRequest$: (token: string) => Observable<any>
    ): Observable<any> {
            ...
            tap(
                ...
                (err) =>
                    this.loader.setError(
                        err.message ? err.message : "Ошибка: " + err
                    )
            )
        );
    }
    ...
    public getData<T>(
        ...
        const http = (token) =>
            this.http
                ...
                .pipe(this.interceptor.interceptor());
